...
public class C01_TreeMapMethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(deneme.tailMap("T",false)); // {Z=30}

        // Java'da baslangic degerleri inclusive'dir. Eger tail alirken
        // verdigimiz baslangic key'ini dahil olmasini istemezsek, false parametresi yazabiliriz
        ...
        // verdigimiz key'den buyuk olan ilk key/entry'yi dndurur.
        ...
        // girilen harf olsaydi nerede olurdu, sonra o ve ondan kucuk olan en buyuk key'i dondurur

        System.out.println(deneme.ceilingKey("K")); // M
        System.out.println(deneme.ceilingKey("T")); // T

        // higher ve lower'dan farklari >=  ,  <= gibi dusunmeleridir
        ...
        // aradakileri entry'leri dondurur
