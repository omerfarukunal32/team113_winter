...
public class C03_NestedMap {
    public static void main(String[] args) {
        ...
        // ogrencileri ayri ayri map yaparsak
        ...
        /*
        {101={SoyIsim=Cem, Bolum=MF, Sube=H, Sinif=10, Isim=Ali},
        102={SoyIsim=Can, Bolum=TM, Sube=M, Sinif=10, Isim=Veli},
        103={SoyIsim=Can, Bolum=Soz, Sube=M, Sinif=11, Isim=Ali}}
         */
