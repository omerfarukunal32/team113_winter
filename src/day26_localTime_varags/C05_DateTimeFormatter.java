...
public class C05_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        /*
            ...
            Ancak bizim istedigimiz formata uygun olarak cavirmemize veya yazdirmamiza iin verir
        ...
        System.out.println(ldt);  // 2023-03-09T20:03:07.349735800

        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd / MMM / yyyy ");

        System.out.println(ldt.format(dtf)); // 09 / März / 2023
        ...
        System.out.println(ldt.format(dtf3)); // Donnerstag:20:14

        DateTimeFormatter dtf4 = DateTimeFormatter.ofPattern("EEEE hh:mm a");

        System.out.println(ldt.format(dtf4));  // Donnerstag 08:17 nachm.
