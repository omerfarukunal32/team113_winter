...
public class   Araba {
    ...
    public Araba(int yil, String marka, String model, boolean hasarliMi, int fiyat){
        /*
            ...
            bir alttaki constructor'da oldugu gibi
            direk atama yapabiliriz

            Ancak genelde projenini daha anlasilir olmasi icin
            ve dogru variable'in kullanilmasi icin
            constructor'daki parametre isimleri, instance variable'lar ile ayni secilir

            Bu durumda Jaca'ya ayni isimdeki iki variable'dan
            hangisinin bu class'daki instance variable oldugunu belirmemiz gerekir.

            bunun icin Java syntax "this." yazilmasi istemistir
            Eger this.  yazmazsak Java en kisa sekilde ulasabilecegi variable'i bulur
         */
        this.yil = yil;
        this.marka = marka;
        this.model = model;
